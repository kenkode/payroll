...
public class pension_employee extends javax.swing.JFrame {

    public pension_employee() {
     Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
     this.setLocation(dim.width/6,dim.height/6);
        initComponents();
        this.setTitle("Pension - Employee");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pension_employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pension_employee().setVisible(true);
            }
        });
    }
