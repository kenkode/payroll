...
public class employee_details extends javax.swing.JFrame {
    ...
    public employee_details() {
        ...
        String pfn_id = New_Employee.PFN();
        pfn.setText(pfn_id);
    ...
    private void initComponents() {
        ...
        setName("Employee Personal Details"); // NOI18N
        setResizable(false);
        ...
        jLabel8.setText("Hospital insuarance:");

        jLabel9.setText("Work permit:");
        ...
        jLabel15.setText("B/F Leave Days:");
        ...
        yob.setDateFormatString("yyyy/MM/dd");

        citizen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kenyan", "Ugandan", "Tanzanian", "Others" }));

        ed_level.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Primary School", "Secondary School", "College Diploma", "University - Graduate", "University - Masters", "University - Docterate" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(sign_path, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cash, 0, 264, Short.MAX_VALUE)
                    .addComponent(mobile)
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(otel2)
                    .addComponent(pemail2)
                    .addComponent(otelext2)
                    .addComponent(mobphone2, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(more1)
                    .addComponent(more3)
                    .addComponent(more4, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        date_joined.setDateFormatString("yyyy/MM/dd");

        jLabel22.setText("Job Group:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(permit)
                            .addComponent(jtitle)
                            .addComponent(date_joined, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(pin))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(active)
                            .addComponent(ok, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cancel)
                            .addComponent(annual, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        try{
        String pdet = "insert into employee(personal_file_number,first_name,last_name,middle_name,identity_number,passport_number,pin,"
                ...
                + "income_tax_applicable,income_tax_relief_applicable,social_security_applicable,hospital_insurance_applicable,"
                + "mode_of_payment,time_clock_rate_normal,day_clock_rate_normal,time_clock_rate_weekday,day_clock_rate_weekday,"
                ...
                + "postal_address,postal_zip,created_on,"
                + "custom_field1,custom_field2,custom_field3,custom_field4,"
                + "photo,signature,bf_leave_days,annual_leave_days"
                + ") values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
                + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        //String bank = "insert into bank(employee_id,emp_bank_id,bank_branch,accno,eft_code)values(?,?,?,?,?)";
        //String conct = "insert into contacts(emloyee_id,office_email,personal_email,office_tel,office_tel_ext,mobile)values(?,?,?,?,?,?)";
        //String med = "insert into medical(emloyee_id,smoker,blood_group,disability,med_condition)values(?,?,?,?,?)";
        ...
        ps.setString(7, pin.getText());
        ps.setString(8, nssf.getText());
        ps.setString(9, nhif.getText());
       ...
       String ed_id = "select * from education_level where education_level_name = ?";
        ...
        String bname = jList1.getSelectedValue().toString();
        
        String[] parts = bname.split(" ",2);
        String part1 = parts[0]; // 004
        String part2 = parts[1];   
        
        String b_id = "select * from branch where branch_shortname = '"+part1+"'";
        ...
        String dpt = jList2.getSelectedValue().toString();
        String[] parts1 = dpt.split(" ",2);
        ...
        String type = jList3.getSelectedValue().toString();
    ...
    String[] extensions = { "jpg", "png", "gif", "bmp" };
        ...
        for (String extension : extensions) {
            try {
                ...
                try {
                    ImageIO.write(imgImage, extension, new File("C:\\Users\\Wango\\Documents\\NetBeansProjects\\payroll\\src\\photo\\employee_"+pfn.getText()+".jpg"));
    ...
    System.out.println("Done");
     ...
     BufferedImage imgImage1 = null;

    String[] extensions1 = { "jpg", "png", "gif", "bmp" };

        for (String extension1 : extensions1) {
            try {
                File url1 = new File(sign_path.getText());
                imgImage1 = ImageIO.read(url1);

                try {
                    ImageIO.write(imgImage1, extension1, new File("C:\\Users\\Wango\\Documents\\NetBeansProjects\\payroll\\src\\signature\\employee_signature_"+pfn.getText()+".jpg"));
                    System.out.println("Write successful");

                } catch (Exception e) {
                    System.out.println("Error on save the image"+e);
                }

            } catch (IOException e) {
                System.out.println("File not found! ." + extension1);
    ...
    System.out.println("Done");
       ...
       JOptionPane.showMessageDialog(null,"Successfully saved employee!");
       new New_Employee().reloadEmployee();
        }
       }catch(Exception e){
    ...
    private void signatureMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signatureMouseClicked
        ...
        String filename = f.getAbsolutePath();
        Image img = getToolkit().getImage(f.getPath());
        Image newimg = img.getScaledInstance(152, 53,  java.awt.Image.SCALE_SMOOTH);
    ...
    rs = ps.executeQuery();
     String[] arr = null;
    while(rs.next()){
        String add1 = rs.getString("branch_name");
        String add2 = rs.getString("branch_shortname");
        
        String concat = add2 + "                                   |"  + add1;
    ...
    try {
    String sql = "SELECT department_name,department_shortname FROM department";
    ps = conn.prepareStatement(sql);
    rs = ps.executeQuery();
    
    while(rs.next()){
        String add1 = rs.getString("department_name");
        String add2 = rs.getString("department_shortname");
       // String longestString = getLongestString(add2);
        //System.out.format("longest string: '%s'\n", longestString);
        
        //add2 += indent.substring(0, indent.length());
    ...
    try {
    String sql = "SELECT * FROM employee_job_group";
    ps = conn.prepareStatement(sql);
    rs = ps.executeQuery();
    
    while(rs.next()){
        String add1 = rs.getString("job_group_narrative");
        String add2 = rs.getString("job_group_name");
        String concat = add2 + "                                   |" + add1;
        lm.addElement(concat);
    }
      jList4.setModel(lm);
    ...
    while(rs.next()){
        String add1 = rs.getString("employee_type_name");
        lm.addElement(add1);
    }
      jList3.setModel(lm);
} catch (Exception e) {
    ...
    public javax.swing.JTextField pfn;
