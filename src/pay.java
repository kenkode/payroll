...
public class pay extends javax.swing.JFrame {
    ...
    private void table(){
        ...
        header.add("BASIC PAY");  
    try{
      ps = conn.prepareStatement("select personal_file_number, concat_ws(' ',first_name,last_name) as name,basic_pay from employee");
      rs = ps.executeQuery();
while(rs.next()){
