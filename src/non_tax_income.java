...
public class non_tax_income extends javax.swing.JFrame {

    public non_tax_income() {
     Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
     this.setLocation(dim.width/6,dim.height/6);
        initComponents();
        this.setTitle("Non - Taxable Income");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(non_tax_income.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new non_tax_income().setVisible(true);
            }
        });
    }
